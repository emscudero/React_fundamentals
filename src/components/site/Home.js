    ...
    <div className="main">
      <div className="mainDiv">
        ...
        <p>
          ...
          application we will work through somne of the basic React concepts,
        ...
        <ul>
          ...
          <li>
            The styling is intenionally bland in some spots. Just a sandbox.
          </li>
          <li>At this phase, this site is not yet responsive.</li>
          <li>
            Refractor the text on this page and make this your own portfolio
            project.
          </li>
          <li>
